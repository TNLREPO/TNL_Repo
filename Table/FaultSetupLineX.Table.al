table 70032 "Fault Setup LineX"
{
    ...
    fields
    {
        ...
        field(4; "No."; Code[20])
        {
            ...
            ELSE
            IF (Type = CONST(Item),
                                     "Service Item Model" = FILTER(<> '')) Item."No." WHERE("Model No." = FIELD("Service Item Model"))
            ELSE
    ...
    var
        ...
        Res: Record Resource;
        item: Record Item;
        faultheader: Record "Fault Setup HeaderX";
        faultLine: Record "Fault Setup HeaderX";
