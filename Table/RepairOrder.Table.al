table 90054 "Repair Order"
{
    ...
    fields
    {
        ...
        field(79; "Repair Order Status"; Option)
        {
            DataClassification = ToBeClassified;
            OptionCaption = 'Awaiting Repair,Being Repaired,Waiting for Inspection,Waiting for Invoicing,Waiting for Settlement,Delivered';
            OptionMembers = "Awaiting Repair","Being Repaired","Waiting for Inspection","Waiting for Invoicing","Waiting for Settlement",Delivered;
        }
        field(80; "BP Amount"; Decimal)
        {
            CalcFormula = Sum("Repair Order Line"."Line Amount" WHERE("Document No." = FIELD("No."),
                                                                       "Job Type" = FILTER(BP)));
        ...
        {
            CalcFormula = Sum("Repair Order Line".VAT WHERE("Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        ...
        {
            CalcFormula = Sum("Repair Order Line"."Amount Inc. VAT" WHERE("Document No." = FIELD("No.")));
            FieldClass = FlowField;
        }
        ...
        field(87; "Estimate Approved"; Boolean)
        {
            ...
            begin
                IF "Estimate Approved" = TRUE THEN
                    "Repair Order Status" := "Repair Order Status"::"Awaiting Repair";
            end;
        }
