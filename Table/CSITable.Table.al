table 50113 "CSI Table"
{
    ...
    fields
    {
        ...
        field(7; "Vehicle Registeration"; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF ServItem.GET("Vehicle Registeration") THEN
                BEGIN
        ...
        field(9;"Impresion of the Service";Option)
        {
            ...
            begin
                ...
                0 : CASE "Impresion of the Service" OF
                     1: Score := Score - 4 + (4 - 1.33);
                     2: Score := Score - 4 + (4 - 2.67);
                     3: Score := Score - 4;
                     END;
                1 : CASE "Impresion of the Service" OF
                     0: Score := Score + 1.33;
                     2: Score := Score + 1.33 - 2.67;
                     3: Score := Score + 1.33 - 4;
                     END;
                2 : CASE "Impresion of the Service" OF
                     1: Score := Score + 2.67 - 1.33;
                     0: Score := Score + 2.67;
                     3: Score := Score + 2.67 - 4;
                     END;
                3 : CASE "Impresion of the Service" OF
                     1: Score := Score + 4 - 1.33;
                     2: Score := Score + 4 - 2.67;
                     0: Score := Score + 4;
                     END;
                END;
        ...
        field(10;"Rate The Competence";Option)
        {
            ...
            begin
                ...
                0 : CASE "Rate The Competence" OF
                     1: Score := Score - 1.9;
                     2: Score := Score - 3.8;
                     3: Score := Score - 5.7;
                     END;
                1 : CASE "Rate The Competence" OF
                     0: Score := Score + 1.9;
                     2: Score := Score + 1.9 - 3.8;
                     3: Score := Score + 1.9 - 5.7;
                     END;
                
                2 : CASE "Rate The Competence" OF
                     1: Score := Score + 3.8 - 1.9;
                     0: Score := Score + 3.8;
                     3: Score := Score + 3.8 - 5.7;
                     END;
                
                3 : CASE "Rate The Competence" OF
                     1: Score := Score + 5.7 - 1.9;
                     2: Score := Score + 5.7 - 3.8;
                     0: Score := Score + 5.7;
                     END;
                END;
        ...
        field(11;"Staff Ability to Estimate/Ind";Option)
        {
            ...
            begin
                ...
                0 : CASE "Staff Ability to Estimate/Ind" OF
                     1: Score := Score - 1.63;
                     2: Score := Score - 3.27;
                     3: Score := Score - 4.9;
                     END;
                
                1 : CASE "Staff Ability to Estimate/Ind" OF
                     0: Score := Score + 1.63;
                     2: Score := Score + 1.63 - 3.27;
                     3: Score := Score + 1.63 - 4.9;
                     END;
                
                2 : CASE "Staff Ability to Estimate/Ind" OF
                     1: Score := Score + 3.27 - 1.63;
                     0: Score := Score + 4.9;
                     3: Score := Score + 3.27 - 4.9;
                     END;
                
                3 : CASE "Staff Ability to Estimate/Ind" OF
                     1: Score := Score + 4.9 - 1.63;
                     2: Score := Score + 4.9 - 3.27;
                     0: Score := Score + 4.9;
                     END;
                END;
        ...
        field(12;"Service Assurance";Option)
        {
            ...
            begin
                ...
                0 : CASE "Service Assurance" OF
                     1: Score := Score - 2.1;
                     2: Score := Score - 4.2;
                     3: Score := Score - 6.3;
                     END;
                
                1 : CASE "Service Assurance" OF
                     0: Score := Score + 2.1;
                     2: Score := Score + 2.1 - 4.2;
                     3: Score := Score + 2.1 - 6.3;
                     END;
                
                2 : CASE "Service Assurance" OF
                     1: Score := Score + 4.2 - 2.1;
                     0: Score := Score + 4.2;
                     3: Score := Score + 4.2 - 6.3;
                     END;
                
                3 : CASE "Service Assurance" OF
                     1: Score := Score + 6.3 - 2.1;
                     2: Score := Score + 6.3 - 4.2;
                     0: Score := Score + 6.3;
                     END;
                 END;
        ...
        field(13;"Interest shown in U as Cust.";Option)
        {
            ...
            begin
                ...
                0 : CASE "Interest shown in U as Cust." OF
                     1: Score := Score - 2.23;
                     2: Score := Score - 4.47;
                     3: Score := Score - 6.7;
                     END;
                
                1 : CASE "Interest shown in U as Cust." OF
                     0: Score := Score + 2.23;
                     2: Score := Score + 2.23 - 4.47;
                     3: Score := Score + 2.23 - 6.7;
                     END;
                
                2 : CASE "Interest shown in U as Cust." OF
                     1: Score := Score + 4.47 - 2.23;
                     0: Score := Score + 4.47;
                     3: Score := Score + 4.47 - 6.7;
                     END;
                
                3 : CASE "Interest shown in U as Cust." OF
                     1: Score := Score + 6.7 - 2.23;
                     2: Score := Score + 6.7 - 4.47;
                     0: Score := Score + 6.7;
                     END;
                 END;    
        ...
        field(14;"Ability to understand Ur need";Option)
        {
            ...
            begin
                ...
                0 : CASE "Ability to understand Ur need" OF
                     1: Score := Score - 2.23;
                     2: Score := Score - 4.47;
                     3: Score := Score - 6.7;
                     END;
                
                1 : CASE "Ability to understand Ur need" OF
                     0: Score := Score + 2.23;
                     2: Score := Score + 2.23 - 4.47;
                     3: Score := Score + 2.23 - 6.7;
                     END;
                
                2 : CASE "Ability to understand Ur need" OF
                     1: Score := Score + 4.47 - 2.23;
                     0: Score := Score + 4.47;
                     3: Score := Score + 4.47 - 6.7;
                     END;
                
                3 : CASE "Ability to understand Ur need" OF
                     1: Score := Score + 6.7 - 2.23;
                     2: Score := Score + 6.7 - 4.47;
                     0: Score := Score + 6.7;
                     END;
        ...
        field(18;"Rate the Service Charge/Job";Option)
        {
            ...
            begin
                ...
                0 : CASE "Rate the Service Charge/Job" OF
                     1: Score := Score - 3.43;
                     2: Score := Score - 6.87;
                     3: Score := Score - 10.3;
                     END;
                
                1 : CASE "Rate the Service Charge/Job" OF
                     0: Score := Score + 3.43;
                     2: Score := Score + 3.43 - 6.87;
                     3: Score := Score + 3.43 - 10.3;
                     END;
                
                2 : CASE "Rate the Service Charge/Job" OF
                     1: Score := Score + 6.87 - 3.43;
                     0: Score := Score + 6.87;
                     3: Score := Score + 6.87 - 10.3;
                     END;
                
                3 : CASE "Rate the Service Charge/Job" OF
                     1: Score := Score + 10.3 - 3.43;
                     2: Score := Score + 10.3 - 6.87;
                     0: Score := Score + 10.3;
                     END;
                 END;
        ...
        field(19;"Rate Work Done / Charge Expl.";Option)
        {
            ...
            begin
                ...
                0 : CASE "Rate Work Done / Charge Expl." OF
                     1: Score := Score - 2.96;
                     2: Score := Score - 5.94;
                     3: Score := Score - 8.9;
                     END;
                
                1 : CASE "Rate Work Done / Charge Expl." OF
                     0: Score := Score + 2.96;
                     2: Score := Score + 2.96 - 5.94;
                     3: Score := Score + 2.96 - 8.9;
                     END;
                
                2 : CASE "Rate Work Done / Charge Expl." OF
                     1: Score := Score + 5.94 - 2.96;
                     0: Score := Score + 5.94;
                     3: Score := Score + 5.94 - 8.9;
                     END;
                
                3 : CASE "Rate Work Done / Charge Expl." OF
                     1: Score := Score + 8.9 - 2.96;
                     2: Score := Score + 8.9 - 5.94;
                     0: Score := Score + 8.9;
                     END;
                 END;
        ...
        field(24;"Rate Willingness to resolve it";Option)
        {
            ...
            begin
                ...
                0 : CASE "Rate Willingness to resolve it" OF
                     1: Score := Score - 2.03;
                     2: Score := Score - 4.07;
                     3: Score := Score - 6.1;
                     END;
                
                1 : CASE "Rate Willingness to resolve it" OF
                     0: Score := Score + 2.03;
                     2: Score := Score + 2.03 - 4.07;
                     3: Score := Score + 2.03 - 6.1;
                     END;
                
                2 : CASE "Rate Willingness to resolve it" OF
                     1: Score := Score + 4.07 - 2.03;
                     0: Score := Score + 4.07;
                     3: Score := Score + 4.07 - 6.1;
                     END;
                
                3 : CASE "Rate Willingness to resolve it" OF
                     1: Score := Score + 6.1 - 2.03;
                     2: Score := Score + 6.1 - 4.07;
                     0: Score := Score + 6.1;
                     END;
                 END;
        ...
        field(34;"Dealer Reminded you of Service";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Dealer Reminded you of Service" = FALSE THEN
                 BEGIN
        ...
        field(35;"Apptmt Date your Desired Date";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Apptmt Date your Desired Date" = FALSE THEN
                 BEGIN
        ...
        field(36;"Workshop easy to Locate";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Workshop easy to Locate" = FALSE THEN
                 BEGIN
        ...
        field(37;"Was the Sevice Facility Clean";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Was the Sevice Facility Clean" = FALSE THEN
                 BEGIN
        ...
        field(38;"SA Treat u wt Courtesy/Respect";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."SA Treat u wt Courtesy/Respect" = FALSE THEN
                 BEGIN
        ...
        field(39;"SA aware of Service History";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."SA aware of Service History" = FALSE THEN
                 BEGIN
        ...
        field(40;"Estimate provided b4 service";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Estimate provided b4 service" = FALSE THEN
                 BEGIN
        ...
        field(41;"Work Completed correctly 1st T";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Work Completed correctly 1st T" = FALSE THEN
                 BEGIN
        ...
        field(42;"Vehicle Ready at Promised Time";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Vehicle Ready at Promised Time" = FALSE THEN
                 BEGIN
        ...
        field(43;"Service/Repair Cost Reasonable";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."Service/Repair Cost Reasonable" = FALSE THEN
                 BEGIN
        ...
        field(44;"SA explained work done at  Del";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."SA explained work done at  Del" = FALSE THEN
                 BEGIN
        ...
        field(45;"SA Advised  Preventive Measure";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."SA Advised  Preventive Measure" = FALSE THEN
                 BEGIN
        ...
        field(46;"PSF Satisfaction Confirmation";Boolean)
        {
            ...
            begin
                AH := 7.69230769230769;
                IF xRec."PSF Satisfaction Confirmation" = FALSE THEN
                 BEGIN
    ...
    begin
        IF "CSI Code" = '' THEN BEGIN
          ...
          NoSeriesMgt.InitSeries(ServiceSetup."CSI No.",xRec."No. Series",0D,"CSI Code","No. Series");
        END;
        AH := 7.69230769230769;
    end;
