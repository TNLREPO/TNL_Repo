table 50058 "VRI Table"
{
    ...
    fields
    {
        ...
        field(30; "Item Entry"; Integer)
        {
            ...
            trigger OnValidate()
            begin
                IF ItemLedgerE.GET("Item Entry") THEN BEGIN
        ...
        {
            CalcFormula = Exist("Service Comment Line" WHERE("Table Name" = filter(7),
        ...
        field(163; "Missing Accessories"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(164; "BnP Problems"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        field(165; "GR Problems"; Boolean)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(254; "User ID"; Code[30])
        {
            DataClassification = ToBeClassified;
        }
        field(255; "Last Date Modified"; Date)
        {
            DataClassification = ToBeClassified;
        }
        field(256; "Current Date"; Date)
        {
            DataClassification = ToBeClassified;
        ...
        field(257; "No. of Due Days"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        ...
        field(268; "NWAwaiting Part (Pre-pulls)"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(269; "NWAwaiting Repairs"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(270; "NWSellable Location"; Integer)
        {
            DataClassification = ToBeClassified;
        }
        field(272; "No. of Days in Stock"; Integer)
        {
            DataClassification = ToBeClassified;
        }
    ...
    var
        ...
        BccAddresses: Text[200];
        Addressee: Text[100];
        Text032: Label 'Mail sent!';
        Text113: Label 'Dear';
        Text114: Label 'Kindly approve this leave request.';
        Text115: Label 'Request false : ';
        Text116: Label 'Requester Name :';
