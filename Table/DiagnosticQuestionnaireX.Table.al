table 70035 "Diagnostic QuestionnaireX"
{
    ...
    fields
    {
        field(1; "DQ No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                IF "DQ No." <> xRec."DQ No." THEN BEGIN
                    SalesSetup.GET;
                    NoSeriesMgt.TestManual("DQ No.");
                    "No. Series" := '';
                END;
            end;
        }
        ...
        {
            OptionCaption = ' ,Fine,Cloudy,Rain,Snow';
            OptionMembers = " ",Fine,Cloudy,Rain,Snow;
        }
        ...
        field(65; "Inspection Details/Result"; Text[250])
        {
        }
    ...
    procedure AssistEdit(OldDiagQue: Record "Diagnostic QuestionnaireX"): Boolean
    var
