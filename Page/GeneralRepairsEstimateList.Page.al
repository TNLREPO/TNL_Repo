page 70081 "General Repairs/Estimate List"
{
    CardPageID = "General Repair/Estimate Card";
    Editable = false;
    PageType = List;
        ...
        area(navigation)
        {
            ...
            action("Print Job Instruction")
            {
                ...
                begin
                    ...
                    IF JIRec.FIND('-') THEN
                        REPORT.RUNMODAL(50311, TRUE, TRUE, JIRec);
                end;
            }
            ...
            action("Generate Estimate")
            {
                ...
                begin
                    ...
                    Rec.TESTFIELD(Rec."Request Batch Name", '');
                    ReqWrkShtName.SETRANGE(ReqWrkShtName."Worksheet Template Name", 'REQ.');
                    ReqWrkShtName.SETRANGE(ReqWrkShtName."No. Of Lines", 0);
    ...
    var
        ...
        SericeItemLine: Record "Service Item Line";
        ServiceLine: Record "Service Line";
        PurchSetup: Record "Purchases & Payables Setup";
        USERSETUP: Record "User Setup";
        JIRec: Record "Customer Order Table.";
        CustOrderLine: Record "Customer Order Line";
        CustOrderLine2: Record "Customer Order Line";
        ServiceLine2: Record "Service Line";
        CustOrderTable: Record "Customer Order Table.";
        PurchOrderHeader: Record "Purchase Header";
        PurchOrderLine: Record "Purchase Line";
        NextLineNo: Integer;
        NoSeriesMgt: Record "No. Series";
        VRI2: Record "VRI Table";
        ItemRec: Record "Item";
        COFRec2: Record "Customer Order Table.";
        VRIRec: Record "VRI Table";
        COFLine: Record "Customer Order Line";
