page 70144 "Approved Opex card2"
{
    PageType = Card;
    ...
    actions
    {
        area(navigation)
        {
            action("Compliance Check")
            {
                ...
                trigger OnAction()
                begin
                    IF"Proposed Purchase Amount" > 150000 THEN
                     IF  "Opex Type"  IN ["Opex Type"::"New Service","Opex Type"::Consumable,"Opex Type"::"Recurrent Service"] THEN
                      IF ("Voucher Raised"= FALSE) THEN
                         LPO.SETRANGE("Purch.Requisition No","No.");
    ...
    var
        ...
        Text002: Label 'This document requires an LPO!';
