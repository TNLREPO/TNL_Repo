page 80014 "Service Complaint Card"
{
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Customer Address1"; Rec."Customer Address1")
                {
                }
                ...
                field("Job Duration"; Rec."Job Duration")
                {
                }
                ...
                field("Corrective Measures"; Rec."Corrective Measures")
                {
                }
                field("Corrective Measures 2"; Rec."Corrective Measures 2")
                {
                }
                field("When Resolved"; Rec."When Resolved")
                {
                }
                field("Amount Expected on Job"; Rec."Amount Expected on Job")
                {
                }
                field("Fault Discovered"; Rec."Fault Discovered")
                {
                }
                field("Last Job/Service Done"; Rec."Last Job/Service Done")
                {
                }
                field("Present Complain"; Rec."Present Complain")
                {
                }
                field("Present Complain 2"; Rec."Present Complain 2")
                {
                }
