page 50319 "Confirmed Appointment"
{
    Editable = false;
    PageType = Card;
    SourceTable = "Customer Order Table.";
    SourceTableView = WHERE("Appt Confirmed" = filter(true));
    ...
    begin
        IF USERSETUP.GET(USERID) THEN
            Rec.SETFILTER("Shortcut Dimension 1 Code", USERSETUP."Global Dimension 1 Filter");
        Rec.SETFILTER("Shortcut Dimension 2 Code", USERSETUP."Global Dimension 2 Filter");
        Rec.FILTERGROUP(2);
    end;
