    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("If Other, Driven by"; Rec."If Other, Driven by")
                {
                }
                field("Contact Available Time from"; Rec."Contact Available Time from")
                {
                }
                field("Multiple Flashing";Rec. "Multiple Flashing")
                {
                }
                field(Condition1;Rec. Condition1)
                {
                }
                field(Condition2;Rec. Condition2)
                {
                }
