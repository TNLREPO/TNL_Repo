page 80054 "Diagnostic Questionnaire List"
{
    CardPageID = "Diagnostic Questionnaire Card";
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("If Other, Driven by"; "If Other, Driven by")
                {
                }
                field("Contact Available Time from"; "Contact Available Time from")
                {
                }
                field("Multiple Flashing"; "Multiple Flashing")
                {
                }
                field(Condition1; Condition1)
                {
                }
                field(Condition2; Condition2)
                {
                }
                ...
                field("If Prediction"; "If Prediction")
                {
                }
