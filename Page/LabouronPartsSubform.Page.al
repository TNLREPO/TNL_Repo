page 70092 "Labour on Parts Subform."
{
    PageType = ListPart;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Qty. to Consume (Base)";Rec."Qty. to Consume (Base)")
                {
                }
                ...
                field("PC Time";Rec."PC Time")
                {
                }
                field("SC Date";Rec."SC Date")
                {
                }
                field("SC Time";Rec."SC Time")
                {
                }
                ...
                field("Quantity Posted";Rec."Quantity Posted")
                {
                }
                field("Res. Hours Total";Rec."Res. Hours Total")
                {
                }
                field("Cost Total";Rec."Cost Total")
                {
                }
                ...
                field("Additional Job";Rec."Additional Job")
                {
                }
