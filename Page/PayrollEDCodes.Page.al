    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(Apportionable; Rec.Apportionable)
                {
                }
                ...
                field("Deduction E/D"; Rec."Deduction E/D")
                {
                }
                ...
                field("Work Days Dependent"; Rec."Work Days Dependent")
                {
                }
                field("Sequence No"; Rec."Sequence No")
                {
                }
                field("Wages Sequence"; Rec."Wages Sequence")
                {
                }
                field("Basic Enquiry"; Rec."Basic Enquiry")
                {
                }
                field("Basic Enquiry-YTD"; Rec."Basic Enquiry-YTD")
                {
                }
                field("Basic Enquiry-CUM2DATE"; Rec."Basic Enquiry-CUM2DATE")
                {
                }
                field("ED Amount"; Rec."ED Amount")
                {
                }
                field("Global Dimension 1 Filter"; Rec."Global Dimension 1 Filter")
                {
                }
                field("Payroll Period Filter"; Rec."Payroll Period Filter")
                {
                }
