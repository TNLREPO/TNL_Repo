page 50603 "Leave Request Card"
{
    ...
    begin
        ...
        //IF  ( "2nd Approval Status" = "2nd Approval Status"::Approved) AND ((Rec."Request Type" ="Request Type"::HOD1) OR (Rec."Request Type" ="Request Type"::Manager) OR
        //    (Rec."Request Type" ="Request Type":: Branch)) OR ("Send to MD for Approval"= TRUE) THEN
        //   Level_3 := TRUE
        //ELSE
        //   Level_3:= FALSE;

        //IF ("3rd Approval Status" = "3rd Approval Status"::Approved ) AND ((Rec."Request Type" ="Request Type":: Branch) OR ("Send to MD for Approval"))THEN
        //   Level_4:= TRUE
        //ELSE
        //   Level_4:= FALSE;
    end;
