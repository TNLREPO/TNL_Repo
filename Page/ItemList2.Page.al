    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Phase out"; Rec."Phase out")
                {
                }
                field("Perfomance Status"; Rec."Perfomance Status")
                {
                }
                field("Last Status Change Date"; Rec."Last Status Change Date")
                {
                }
                field("Reorder Period"; Rec."Reorder Period")
                {
                }
                field("Maximum Period"; Rec."Maximum Period")
                {
                }
                field("Article Group"; Rec."Article Group")
                {
                }
                field("Special Attn"; Rec."Special Attn")
                {
                }
                field("Created On"; Rec."Created On")
                {
                }
                field("Phase-In Transaction"; Rec."Phase-In Transaction")
                {
                }
                field("Phase-Out Transaction"; Rec."Phase-Out Transaction")
                {
                }
                field("Phase-In  Period"; Rec."Phase-In  Period")
                {
                }
                field("Phase-Out  Period"; Rec."Phase-Out  Period")
                {
                }
                field("Slow Moving Period"; Rec."Slow Moving Period")
                {
                }
                field("Period Unit"; Rec."Period Unit")
                {
                }
                field("Lead Time Period"; Rec."Lead Time Period")
                {
                }
                field("Use Item Setup"; Rec."Use Item Setup")
                {
                }
                field("Transaction Count"; Rec."Transaction Count")
                {
                }
                field("Order Cycle"; Rec."Order Cycle")
                {
                }
                field("Safety Stock of Lead Time"; Rec."Safety Stock of Lead Time")
                {
                }
                field("Obsolete Period"; Rec."Obsolete Period")
                {
                }
                ...
                field("ABC-Classification"; Rec."ABC-Classification")
                {
                }
                field("SIIC-Code"; Rec."SIIC-Code")
                {
                }
                field("Customs-Tarif"; Rec."Customs-Tarif")
                {
                }
                field("Currency Code"; Rec."Currency Code")
                {
                }
                field("Block Price Group Update"; Rec."Block Price Group Update")
                {
                }
                field("Old Salesprice"; Rec."Old Salesprice")
                {
                }
                field("Old Salesfactor"; Rec."Old Salesfactor")
                {
                }
                field(ICC; Rec.ICC)
                {
                ...
                field("Loss Sales"; Rec."Loss Sales")
                {
                }
                field(MAD; Rec.MAD)
                {
                }
                field("Back/On Order"; Rec."Back/On Order")
                {
                }
                field(StockValInv; Rec.StockValInv)
                {
                }
                field(CostValue4Sales; Rec.CostValue4Sales)
                {
                }
                field("Stock/Value differ"; Rec."Stock/Value differ")
                {
                }
                field("Inventory Posting Grp Filter"; Rec."Inventory Posting Grp Filter")
                {
                }
                field("MVO Count"; Rec."MVO Count")
                {
                }
                field("MVO Purchaser Filter"; Rec."MVO Purchaser Filter")
                {
                }
                field("MVO Model Filter"; Rec."MVO Model Filter")
                {
                }
                field("Customer Gen Post Grp Filter"; Rec."Customer Gen Post Grp Filter")
                {
                }
                field("Customer Filter"; Rec."Customer Filter")
                {
                }
                field("Model Group Filter"; Rec."Model Group Filter")
                {
                }
                field("Model Category Filter"; Rec."Model Category Filter")
                {
                }
                field("PO Filter"; Rec."PO Filter")
                {
                }
                field("Colour Filter"; Rec."Colour Filter")
                {
                }
                field(Obsolete; Rec.Obsolete)
                {
                }
                field("Actual Qty Demanded"; Rec."Actual Qty Demanded")
                {
                }
            }
        }
