    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Dealer Verification No."; Rec."Dealer Verification No.")
                {
                }
        ...
        area(factboxes)
        {
            ...
            part("Sales Hist. Sell-to FactBox"; 9080)
            {
            ...
            part("Service Hist. Sell-to FactBox"; 9085)
            {
                SubPageLink = "No." = FIELD("No."),
                              "Currency Filter" = FIELD("Currency Filter"),
                              "Date Filter" = FIELD("Date Filter"),
            ...
            part("Service Hist. Bill-to FactBox"; 9086)
            {
                SubPageLink = "No." = FIELD("No."),
                              "Currency Filter" = FIELD("Currency Filter"),
                              "Date Filter" = FIELD("Date Filter"),
