page 50622 "Motor Show Repair Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("PDI Section Action")
            {
                ...
                field("Document Link"; "Incoming Document Entry No.1")
                {
                ...
                field("Send Attach File"; "Send Attach File")
                {
                    Caption = 'Send Attach File';
                }
                field("Send Attach Name"; "Send Attach Name")
                {
    ...
    begin
        ...
        IF "Send for Approval" = FALSE THEN BEGIN
            GeneralEdit := TRUE;
            EventMrgEdit := TRUE;
        ...
        IF "2nd Approval Status" = "2nd Approval Status"::" " THEN BEGIN
