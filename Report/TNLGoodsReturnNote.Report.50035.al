report 50035 "TNL Goods Return-Note"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLGoodsReturnNote.50035.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table114)
        {
            ...
            dataitem(DataItem1000000011; Table115)
            {
                ...
                column(Inventory_Posting_Grp; "Sales Cr.Memo Line"."Inventory Posting Grp.")
                {
                }
                column(Customer_Name; "Sales Cr.Memo Line"."Customer Name")
                {
                }
            }
