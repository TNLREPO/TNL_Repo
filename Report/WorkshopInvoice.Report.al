report 50404 "Workshop Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './WorkshopInvoice.rdlc';
        ...
        dataitem(DataItem7672; Table50119)
        {
            ...
            dataitem(DataItem6850; Table50122)
            {
                ...
                begin
                    ...
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::GR);
                    CustOrderLine.SETRANGE("Line Type", "Customer Order Line"."Line Type"::Item);
                    CustOrderLine.SETRANGE("Customer Order Form No.", "Customer Order Line"."Customer Order Form No.");
                    ...
                    CustOrderLine.SETCURRENTKEY("Job Type", "Line Type", "Customer Order Form No.");
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::PM);
                    CustOrderLine.SETRANGE("Line Type", "Customer Order Line"."Line Type"::Item);
                    CustOrderLine.SETRANGE("Customer Order Form No.", "Customer Order Line"."Customer Order Form No.");
                    IF CustOrderLine.FINDFIRST THEN BEGIN
                        CustOrderLine.CALCSUMS(Amount);
                    ...
                    CustOrderLine.SETCURRENTKEY("Job Type", "Line Type", "Customer Order Form No.");
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::GR);
                    CustOrderLine.SETRANGE("Line Type", "Customer Order Line"."Line Type"::Labour);
                    CustOrderLine.SETRANGE("Customer Order Form No.", "Customer Order Line"."Customer Order Form No.");
                    IF CustOrderLine.FINDFIRST THEN BEGIN
                        CustOrderLine.CALCSUMS(Amount);
                    ...
                    CustOrderLine.SETCURRENTKEY("Job Type", "Line Type", "Customer Order Form No.");
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::GR);
                    CustOrderLine.SETRANGE("Line Type", "Customer Order Line"."Line Type"::"Sundry Spares");
                    CustOrderLine.SETRANGE("Customer Order Form No.", "Customer Order Line"."Customer Order Form No.");
                    IF CustOrderLine.FINDFIRST THEN BEGIN
                        CustOrderLine.CALCSUMS(Amount);
                    ...
                    CustOrderLine.RESET;
                    CustOrderLine.SETCURRENTKEY("Job Type", "Line Type", "Customer Order Form No.");
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::"B&P");
                    CustOrderLine.SETRANGE("Line Type", "Customer Order Line"."Line Type"::Item);
                    CustOrderLine.SETRANGE("Customer Order Form No.", "Customer Order Line"."Customer Order Form No.");
                    IF CustOrderLine.FINDFIRST THEN BEGIN
                        CustOrderLine.CALCSUMS(Amount);
                    ...
                    IF COFRec.GET("Customer Order Line"."Customer Order Form No.") THEN
