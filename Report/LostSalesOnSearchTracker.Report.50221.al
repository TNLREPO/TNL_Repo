...
{
    DefaultLayout = RDLC;
    RDLCLayout = './LostSalesOnSearchTracker.50221.rdlc';

    dataset
    {
        dataitem(DataItem8437; Table50095)
        {
            DataItemTableView = SORTING (Part No, Request Date);
            ...
            begin
                ...
                IF Item.GET("Parts Enquiry"."Part No") THEN BEGIN
                    ...
                    ELSE
                        SO := 0;
                END;
                LossValue := "Parts Enquiry"."Lost Quantity" * Item."Unit Price";
            end;
