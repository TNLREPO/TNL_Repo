report 50180 "TNL Sales Quotation"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLSalesQuotation.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table36)
        {
            ...
            dataitem(DataItem1000000006; Table37)
            {
            ...
            begin
                IF CustRec.GET("Sell-to Customer No.") THEN BEGIN
                    CustomerAddr[1] := CustRec.Name;
                    CustomerAddr[2] := CustRec."Name 2";
                    CustomerAddr[3] := CustRec.Address;
                    CustomerAddr[4] := CustRec."Address 2";
                    CustomerAddr[5] := CustRec.City;
                    CustomerAddr[6] := CustRec.Contact;
                    COMPRESSARRAY(CustomerAddr);
                END;

                CALCFIELDS("Amount Including VAT");
                AMOUNTINWORD := figure("Amount Including VAT", 'NAIRA', 'KOBO');
    ...
    var
        ...
        CustomerAddr: array[8] of Text[70];
