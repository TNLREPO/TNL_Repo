report 50311 "Job Instruction II"
{
    DefaultLayout = RDLC;
    RDLCLayout = './JobInstructionII.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table50119)
        {
            ...
            dataitem(DataItem1000000135; Table50122)
            {
                DataItemLink = Customer Order Form No.=FIELD(Customer Order Form No.);
                DataItemTableView = SORTING (Customer Order Form No., Line No.);
