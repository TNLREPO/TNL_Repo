report 50417 "e-Receipt-Dollar."
{
    DefaultLayout = RDLC;
    RDLCLayout = './eReceiptDollar.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            column(AccountDescription_PaymentReceipt; "Payment/Receipt."."Account Description")
            {
            }
            ...
            column(Bal_Acc_Description; "Bal. Acc. Description")
            {
            }
            dataitem(DataItem1385; Table50104)
            {
                ...
                column(Amount_PaymentReceiptBalLine;ABS("Payment/Receipt Bal. Line.".Amount))
                {
                }
                ...
                column(TransactionDescription_PaymentReceiptBalLine;"Payment/Receipt Bal. Line."."Transaction Description")
                {
                }
                column(AmountLCYBalLine;ABS("Payment/Receipt Bal. Line."."Amount (LCY)"))
                {
                }
            ...
            begin
                ...
                AMOUNTINWORD := figure(Amount,'DOLLAR','CENT');
                ...
                ELSE
                detatype := FALSE;
                IF "Payment/Receipt.".Amount = 0 THEN
                "Payment/Receipt.".Amount := "Payment/Receipt.".Amount;
