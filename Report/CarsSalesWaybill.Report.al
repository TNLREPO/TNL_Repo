report 50352 "Cars Sales Way bill!"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CarsSalesWaybill.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table110)
        {
            ...
            column(CompanyDataInternationphone; CompanyData."Internation phone")
            {
            }
            column(BilltoCustomerNo_SalesShipmentHeader; "Sales Shipment Header"."Bill-to Customer No.")
            {
            }
            column(CompanyDataVATRegNo; CompanyData."VAT Reg. No.")
            {
            }
            column(CompanyDataFaxNo; CompanyData."Fax No.")
            {
            }
            column(CompanyInfoInternationphone; CompanyInfo."Internation phone")
            {
            }
            column(CompanyInfoVATRegNo; CompanyInfo."Registration No.")
            {
            }
            ...
            column(CompanyInfoCode; CompanyInfo.Condition)
            {
            }
            column(CompanyInfoCity; CompanyInfo.City)
            {
            }
            column(CompanyInfoShipAddress; CompanyInfo."Ship-to Address")
            {
            }
            column(CompanyInfoShipAddress2; CompanyInfo."Ship-to Address 2")
            {
            }
            ...
            column(PostingTime_SalesShipmentHeader; "Sales Shipment Header".Posting_Time)
            {
            }
