...
{
    DefaultLayout = RDLC;
    RDLCLayout = './ServiceRateWidthByDepth.rdlc';
    ...
    dataset
    {
        dataitem(DataItem6836; Table18)
        {
            ...
            column(Customer_GETFILTERS;Customer.GETFILTERS)
            {
            }
            ...
            begin
                ...
                SalesInvLine.SETFILTER("Posting Date",'%1..%2',Customer.GETRANGEMIN("Date Filter"),Customer.GETRANGEMAX("Date Filter"));
    ...
    begin
        ...
        IF salesinv.FINDSET THEN REPEAT
