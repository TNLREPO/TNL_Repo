report 50003 "Cash Payment Voucher-Sing."
{
    DefaultLayout = RDLC;
    RDLCLayout = './CashPaymentVoucherSing.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            column(CollectedBy_PaymentReceipt; "Payment/Receipt."."Collected By")
            {
            }
