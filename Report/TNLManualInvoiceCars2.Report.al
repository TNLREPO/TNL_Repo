report 50282 "TNL Manual Invoice Cars2"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/TNLManualInvoiceCars2.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Sales Header")
        {
            ...
            column(AmountWords; AmountInWords2)
            {
            }
            ...
            dataitem(Counter; Integer)
            {
                ...
                dataitem(SalesLine; "Sales Line")
                {
                    ...
                    column(Isolo_Express_Road__IsoloCaptionc; Isolo_Express_Road__IsoloCaptionLbl)
                    {
                    }
