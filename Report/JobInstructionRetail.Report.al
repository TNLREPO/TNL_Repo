report 50308 "Job Instruction Retail"
{
    DefaultLayout = RDLC;
    RDLCLayout = './JobInstructionRetail.rdlc';

    dataset
    {
        dataitem(DataItem7672; Table70034)
        {
            ...
            column(JobType2_CustomerOrderHeader; "Job Type2")
            {
            }
            ...
            column(QuantityRequested_CustomerOrderLine; CustomerOrderLine."Quantity Requested")
            {
            }
            ...
            column(JREStaffName_CustomerOrderHeader; "JRE Staff Name")
            {
            }
            ...
            column(QCStaffCode_CustomerOrderHeader; "QC Staff Code")
            {
            }
            column(QCStaffName_CustomerOrderHeader; "QC Staff Name")
            {
            }
            column(TechnicianName_CustomerOrderHeader; "Technician Name")
            {
            }
            column(ReceptionStaffName_CustomerOrderHeader; "Reception Staff Name")
            {
            }
            column(CTHome_CustomerOrderHeader; "CT Home")
            {
            }
            column(CTMobile_CustomerOrderHeader; "CT Mobile")
            {
            }
            column(CTBusiness_CustomerOrderHeader; "CT Business")
            {
            }
            column(ContactTelephone_CustomerOrderHeader; "Contact Telephone")
            {
            }
            column(JIEmail_CustomerOrderHeader; "JI E-mail")
            {
            }
            column(JIOther_CustomerOrderHeader; "JI Other")
            {
            }
            column(JIOtherII_CustomerOrderHeader; "JI Other II")
            {
            }
            column(JIEMail2_CustomerOrderHeader; "JI EMail2")
            {
            }
            column(PSFUStaffName_CustomerOrderHeader; "P.S.F.U. Staff Name")
            {
            }
            column(PSFUConfirmedby_CustomerOrderHeader; "P.S.F.U. Confirmed by")
            {
            }
            column(DateDelivered_CustomerOrderHeader; "Date Delivered")
            {
            }
            column(TimeDelivered_CustomerOrderHeader; "Time Delivered")
            {
            }
            column(CCDate_CustomerOrderHeader; "CC Date")
            {
            }
            column(CCTime_CustomerOrderHeader; "CC Time")
            {
            }
            column(CCStaffName_CustomerOrderHeader; "CC Staff Name")
            {
            }
            column(ActualHoursClocked_CustomerOrderHeader; FORMAT("Actual Hours Clocked"))
            {
            }
            column(JStart; JStart)
            {
            }
            ...
            dataitem(DataItem6850; Table70036)
            {
                DataItemLink = Document No.=FIELD(No.);
                RequestFilterFields = "Job Type";
                ...
                column(Customer_Order_Line_Quantity_Requested; "Quantity Requested")
                {
                }
                column(Customer_Order_Line__Unit_Price_; "Unit Price")
                {
                }
                column(Type_CustomerOrderLine; Type)
                {
                }
                ...
                column(Customer_Order_Line_QuantityCaption; FIELDCAPTION("Quantity Received"))
                {
                }
            ...
            begin
                ...
                IF Clocking.FINDFIRST THEN
                    JStart := Clocking."Start Date";

                Clocking.SETRANGE("Job No.", "No.");
                IF Clocking.FINDLAST THEN
                    JEnd := Clocking."End Date";
            end;
        }
    }
    ...
    var
        ...
        THE_EXPLANATION_AND_QUALITY_OF_THE_SERVICE_AND_OR_REPAIR_TO_THIS_VEHICLE_WAS_SATISFACTORILY_CONFIRMED_BY_THE_UNDERSIGNED_CUSTLbl: Label 'THE EXPLANATION AND QUALITY OF THE SERVICE AND OR REPAIR TO THIS VEHICLE WAS SATISFACTORILY CONFIRMED BY THE UNDERSIGNED CUSTOMER DURING VEHICLE DELIVERY.';
        Customer_Name__________________________________________________________________CaptionLbl: Label 'Customer Name: ________________________________________________________________';
        Signature_______________________________________________CaptionLbl: Label 'Signature: _____________________________________________';
        Date___Time__________________________________________CaptionLbl: Label 'Date / Time: ________________________________________';
