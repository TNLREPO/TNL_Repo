...
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/ChequePaymentVoucherSing.rdl';
    ...
    dataset
    {
        dataitem(DataItem5195; "Payment/Receipt.")
        {
            ...
            column(BalanceAccountNo_PaymentReceipt; "Balance Account No.")
            {
            }
            column(BalAccDescription_PaymentReceipt; "Bal. Acc. Description")
            {
            }
            column(CapexOpexNo_PaymentReceipt; "Procurement No.")
            {
            }
            ...
            begin
                ...
                IF ("Account Type" IN ["Account Type"::"G/L Account",
                  "Account Type"::"Bank Account"]) AND ("Balance Account Type" IN
