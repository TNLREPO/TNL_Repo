report 50004 "Cheque Payment Voucher-Sing."
{
    DefaultLayout = RDLC;
    RDLCLayout = './ChequePaymentVoucherSing.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            begin
                ...
                CompanyAddr[2] := CompanyData."Name 2";
                CompanyAddr[3] := CompanyData.Address;
                CompanyAddr[4] := CompanyData."Address 2";
                CompanyAddr[5] := CompanyData.City;
                CompanyAddr[6] := CompanyData."Phone No.";
                CompanyAddr[7] := CompanyData."Fax No.";
                CompanyAddr[8] := CompanyData."Registration No.";
