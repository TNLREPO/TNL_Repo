...
{
    DefaultLayout = RDLC;
    RDLCLayout = './ServiceRateDetailSummary.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1570; Table113)
        {
            ...
            column(OrderType_SalesInvoiceLine; "Sales Invoice Line"."Order Type")
            {
            }
            ...
            begin
                ...
                ELSE
                    LnSup := 0;
                IF "Sales Invoice Line"."Fully Invoiced" THEN
                    FuInv := 1 ELSE
                    FuInv := 0;
            ...
            begin
                ...
                CurrReport.CREATETOTALS(Lndem, LnSup, FuInv);
            end;
        }
    }
