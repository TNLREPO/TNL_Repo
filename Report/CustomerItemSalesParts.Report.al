report 50205 "Customer/Item Sales Parts"
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerItemSalesParts.rdlc';
    ...
    dataset
    {
        dataitem(DataItem6836; Table18)
        {
            ...
            column(Product_Codes; ValueEntryBuffer."Product Group Code")
            {
            }
            ...
            dataitem(DataItem5444;Table2000000026)
            {
                ...
                column(Products_Code;ValueEntryBuffer."Product Group Code")
                {
                }
                ...
                column(ValueEntryBufferProductGrpCode;ValueEntryBuffer."Product Grp Code")
                {
                }
                column(Item_Prod_Code;Item."Prod. Code")
                {
                }
                column(Item_Prod_GRP;Item."Item No Category")
                {
                }
                ...
                column(ItedgerEntryProductGrpCode;"Item Ledger Entry"."Product Grp Code")
                {
                }
