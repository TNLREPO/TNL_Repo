...
{
    DefaultLayout = RDLC;
    RDLCLayout = './CustomerDetailTrialBal2.rdlc';
        ...
        dataitem(DataItem6836; Table18)
        {
            ...
            dataitem(DataItem8503; Table21)
            {
                ...
                begin
                    ...
                    CustBalance := CustBalance + "Cust. Ledger Entry".Amount;  //sgg
            ...
            dataitem(DataItem5444;Table2000000026)
            {
                ...
                column(StartBalance____Cust__Ledger_Entry__Amount;StartBalance + "Cust. Ledger Entry".Amount)
                {
                    AutoFormatType = 1;
                }
                column(StartBalanceLCY____Cust__Ledger_Entry___Amount__LCY___Control1000000006;StartBalanceLCY + "Cust. Ledger Entry"."Amount (LCY)")
                {
                    AutoFormatType = 1;
                }
                ...
                column(StartBalance____Cust__Ledger_Entry__Amount_Control17;StartBalance + "Cust. Ledger Entry".Amount)
                {
                    AutoFormatType = 1;
                }
                ...
                column(StartBalanceLCY____Cust__Ledger_Entry___Amount__LCY___Control1000000007;StartBalanceLCY + "Cust. Ledger Entry"."Amount (LCY)")
                {
                    AutoFormatType = 1;
                }
            ...
            begin
                ...
                CurrReport.CREATETOTALS("Cust. Ledger Entry"."Amount (LCY)",StartBalanceLCY,StartBalance);
            end;
        }
    }
