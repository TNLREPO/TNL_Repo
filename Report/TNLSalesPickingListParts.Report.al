report 50178 "TNL Sales Picking List- Parts"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLSalesPickingListParts.rdlc';
    ...
    dataset
    {
        dataitem(DataItem6640; Table36)
        {
            ...
            column(CustomerPreferredName_SalesHeader;"Sales Header"."Customer Preferred Name")
            {
            }
