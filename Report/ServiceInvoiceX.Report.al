...
{
    DefaultLayout = RDLC;
    RDLCLayout = './ServiceInvoiceX.rdlc';
    Caption = 'Service - Invoice';
    Permissions = TableData 7190 = rimd;

    dataset
    {
        dataitem(DataItem5614; Table5992)
        {
            ...
            column(CustomerOrderNo_ServiceInvoiceHeader; "Service Invoice Header"."Customer Order No.")
            {
            }
            column(RegistrationNo_ServiceInvoiceHeader; "Service Invoice Header"."Registration No.")
            {
            }
            ...
            column(TotalPaintcost_ServiceInvoiceHeader; "Service Invoice Header"."Total Paint cost")
            {
            }
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    dataitem(DataItem2800; Table5993)
                    {
                        ...
                        dataitem("Service Shipment Buffer"; Table2000000026)
                        {
                            DataItemTableView = SORTING (Number);
                        ...
                        begin
                            ...
                            //VATPaint := 0.075 * "Service Invoice Header"."Total Paint cost";
                            TypeInt := Type;

                            TotalLineAmount := TotalLineAmount2 + "Service Invoice Header"."Total Paint cost";
                            TotalAmount := TotalAmount2 + "Service Invoice Header"."Total Paint cost";
                            TotalAmountInclVAT := TotalAmountInclVAT2 + "Service Invoice Header"."Total Paint cost" + VATPaint;
                        end;
