report 50060 "Bank Report + Emolument"
{
    // This report prints the payment schedules to banks.
    DefaultLayout = RDLC;
    RDLCLayout = './BankReportEmolument.rdlc';
    ...
    dataset
    {
        dataitem(DataItem6885; Table50012)
        {
            ...
            dataitem(DataItem7528; Table5200)
            {
                ...
                column(EmolumentNet; EmolumentNet)
                {
                }
                ...
                column(Emolument_NetCaption; Emolument_NetCaptionLbl)
                {
                }
                ...
                begin
                    ...
                    CALCFIELDS(Employee."Emolument EDAmount");
                    EmolumentNet := Employee."Emolument EDAmount";
            ...
            dataitem(Totals; Table2000000026)
            {
                ...
                column(EmolumentNet_Control1000000036; EmolumentNet)
                {
                }
                column(NetAmount_Control1000000037; NetAmount)
                {
                }
    ...
    var
        ...
        Emolument_NetCaptionLbl: Label 'Emolument Net';
