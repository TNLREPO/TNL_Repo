report 50636 "Approved Estimate"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ApprovedEstimate.rdlc';
    ...
    dataset
    {
        dataitem(DataItem7672; Table70034)
        {
            ...
            dataitem(DataItem6850; Table70036)
            {
                ...
                DataItemTableView = WHERE (Skip Zero Qty=CONST(Yes));
                ...
                column(UnitofMeasure_CustomerOrderLineX; "Customer Order LineX"."Unit of Measure")
                {
                }
                column(UnitPrice_CustomerOrderLineX; "Customer Order LineX"."Unit Price")
                {
                }
                column(Type_CustomerOrderLineX; "Customer Order LineX".Type)
                {
                }
                column(AmountIncVAT_CustomerOrderLineX; "Customer Order LineX"."Amount Inc. VAT")
                {
                }
                column(Amount_CustomerOrderLineX; "Customer Order LineX".Amount)
                {
                }
                column(DiscountAmount_CustomerOrderLineX; "Customer Order LineX"."Line Discount Amount")
                {
                }
                column(VATAmount_CustomerOrderLineX; "Customer Order LineX"."VAT Amount")
                {
                }
                column(SkipZeroQty_CustomerOrderLineX; "Customer Order LineX"."Skip Zero Qty")
                {
                }
                ...
                begin
                    ...
                    //  TotalValue := TotalEstimate + VATEstimate - "Customer Order HeaderX"."Total Line Discount";
                end;
