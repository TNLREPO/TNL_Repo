report 50427 "e-Receipt-Sing."
{
    DefaultLayout = RDLC;
    RDLCLayout = './eReceiptSing.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            column(Amount_PaymentReceipt; "Payment/Receipt.".Amount)
            {
            }
            ...
            column(AmountLCY_PaymentReceipt; ABS("Payment/Receipt."."Amount (LCY)"))
            {
            }
            column(Receivedby_PaymentReceipt; "Payment/Receipt."."Received by")
            {
            }
