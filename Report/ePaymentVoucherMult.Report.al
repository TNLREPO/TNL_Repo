report 50017 "e-Payment Voucher-Mult."
{
    DefaultLayout = RDLC;
    RDLCLayout = './ePaymentVoucherMult.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            column(ChequeNo_PaymentReceipt; "Payment/Receipt."."Cheque No.")
            {
            }
            ...
            column(AccountType_PaymentReceipt; "Payment/Receipt."."Account Type")
            {
            }
            ...
            dataitem(DataItem1385; Table50104)
            {
                ...
                column(Payment_Receipt_Bal__Line___Account_No__;COPYSTR("Account No.",1,30))
                {
                }
            ...
            begin
                ...
                IF "Amount (LCY)" = 0 THEN BEGIN
                  CALCFIELDS("Total Amount on Line");
                  AMOUNTINWORD := figure("Total Amount on Line",'NAIRA','KOBO');
    ...
    var
        ...
        CompanyAddr: array [6] of Text[50];
        CreditAccNo: Code[10];
        CreditAccName: Text[50];
