report 50437 "Pre Own TNL Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './PreOwnTNLSalesInvoice.rdlc';
            ...
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    dataitem(DataItem1570; Table113)
                    {
                        ...
                        column(Colour_SalesInvoiceLine; "Sales Invoice Line".Colour)
                        {
                        }
                        ...
                        column(YearofProduction_SalesInvoiceLine; "Sales Invoice Line"."Year of Production")
                        {
                        }
                        column(EstimatedMileage_SalesInvoiceLine; "Sales Invoice Line"."Estimated Mileage")
                        {
                        }
