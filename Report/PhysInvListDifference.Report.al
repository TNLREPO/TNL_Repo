...
{
    DefaultLayout = RDLC;
    RDLCLayout = './PhysInvListDifference.rdlc';
    ...
    dataset
    {
        dataitem(DataItem8780; Table233)
        {
            ...
            column(Item_Journal_Line__Posting_Date_Caption; "Item Journal Line".FIELDCAPTION("Posting Date"))
            {
            }
            ...
            column(Item_Journal_Line__Shelf_No__Caption; "Item Journal Line".FIELDCAPTION("Shelf No."))
            {
            }
            column(Item_Journal_Line__Location_Code_Caption; "Item Journal Line".FIELDCAPTION("Location Code"))
            {
            }
            column(Item_Journal_Line__Qty___Calculated__Caption; "Item Journal Line".FIELDCAPTION("Qty. (Calculated)"))
            {
            }
            ...
            column(Item_Journal_Line_AmountCaption; "Item Journal Line".FIELDCAPTION(Amount))
            {
            }
            column(Item_Journal_Line__Unit_Amount_Caption; "Item Journal Line".FIELDCAPTION("Unit Amount"))
            {
            }
