report 50207 "TNL Sale_nvoice TSP1001"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/TNLSalenvoiceTSP1001.rdl';
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    dataitem(SalesInvLineData; "Sales Invoice Line")
                    {
                        ...
                        DataItemTableView = SORTING("Document No.", "Line No.")
                                            WHERE("Posting Group" = CONST('N_PARTS'));
                        column(SalesLineFilters; SalesLineFilters)
                        {
                        }
                        ...
                        column(ActualSellingPrice; Amount - SalesInvLineData."Line Discount Amount")
                        {
                        }
                        ...
                        dataitem(AsmLoop; Integer)
                        {
                            ...
                            begin
                                ...
                                IF ItemTranslation.GET(TempPostedAsmLine."No.",
                                     TempPostedAsmLine."Variant Code", SalesInvHeader."Language Code")
                                THEN
    ...
    begin
        ...
        SalesLineFilters := SalesInvLineData.GETFILTERS;
...
#pragma warning restore AL0432
        ...
        Text011: Label 'Sales Line Filter:-';
