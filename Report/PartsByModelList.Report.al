...
{
    DefaultLayout = RDLC;
    RDLCLayout = './PartsByModelList.rdlc';

    dataset
    {
        dataitem(DataItem2026; Table50014)
        {
            ...
            dataitem(DataItem4229; Table50023)
            {
                ...
                column(CurrReport_PAGENO_Control1000000047; CurrReport.PAGENO)
                {
                }
