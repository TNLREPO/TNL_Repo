report 50056 "TNL Sales Invoice Copy"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLSalesInvoiceCopy.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5581; Table112)
        {
            ...
            column(SalesInvoiceLine_GetCurrencyCode; "Sales Invoice Line".GetCurrencyCode)
            {
            }
            ...
            column(PostingTime_SalesInvoiceHeader; "Sales Invoice Header".Posting_Time)
            {
            }
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(SN_SalesInvoiceHeader; "Sales Invoice Header"."S/N")
                    {
                    }
                    column(Quantityies_SalesInvoiceHeader; "Sales Invoice Header"."Quantity(ies)")
                    {
                    }
                    column(TotalAmount_SalesInvoiceHeader; "Sales Invoice Header"."Total Amount")
                    {
                    }
