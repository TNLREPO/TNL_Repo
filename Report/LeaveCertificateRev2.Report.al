report 50129 "Leave Certificate-Rev2"
{
    ...
    var
        ...
        FailureText: Label 'Please note that failure to return to duty on the above date without accepted excuse will be treated as unauthorised absence.';
