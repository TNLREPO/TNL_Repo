...
{
    DefaultLayout = RDLC;
    RDLCLayout = './VendorDetailTrialBalance2.rdlc';
    ...
    dataset
    {
        dataitem(DataItem3182; Table23)
        {
            ...
            column(Vendor_Ledger_Entry__Amount; "Vendor Ledger Entry".Amount)
            {
                AutoFormatType = 1;
            }
            column(StartBalance____Vendor_Ledger_Entry__Amount; StartBalance + "Vendor Ledger Entry".Amount)
            {
                AutoFormatType = 1;
            }
            ...
            dataitem(DataItem5444;Table2000000026)
            {
                ...
                column(StartBalance____Vendor_Ledger_Entry__Amount_Control55;StartBalance + "Vendor Ledger Entry".Amount)
                {
                    AutoFormatType = 1;
                }
                column(StartBalanceLCY____Vendor_Ledger_Entry___Amount__LCY___Control1000000011;StartBalanceLCY + "Vendor Ledger Entry"."Amount (LCY)")
                {
                    AutoFormatType = 1;
                }
                ...
                column(StartBalance____Vendor_Ledger_Entry__Amount_Control56;StartBalance + "Vendor Ledger Entry".Amount)
                {
                    AutoFormatType = 1;
                }
                column(StartBalanceLCY____Vendor_Ledger_Entry___Amount__LCY___Control1000000012;StartBalanceLCY + "Vendor Ledger Entry"."Amount (LCY)")
                {
                    AutoFormatType = 1;
                }
