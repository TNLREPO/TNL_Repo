report 50117 "TNL Sales Picking List- Cars"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLSalesPickingListCars.rdlc';
        ...
        dataitem(DataItem6640; Table36)
        {
            ...
            dataitem(Counter;Table2000000026)
            {
                ...
                dataitem(DataItem2844;Table37)
                {
                    ...
                    column(CompanyData_Registration_No;CompanyData."Registration No.")
                    {
                    }
                    column(CompanyDataVATRegistrationNo;CompanyData."VAT Registration No.")
                    {
                    }
                    column(CompanyDataShipCode;CompanyData."Ship-to Post Code")
                    {
                    }
                    column(CompanyDataIndustrialClassification;CompanyData."Industrial Classification")
                    {
                    }
                    column(CompanyDataAltCompName;CompanyData."Alt Comp. Name")
                    {
                    }
                    column(CompanyDataCondition;CompanyData.Condition)
                    {
                    }
                    column(CompanyDataShipContact;CompanyData."Ship-to Contact")
                    {
                    }
                    column(CompanyDataShip2;CompanyData."Ship-to Name 2")
                    {
                    }
                    ...
                    column(CompanyDataship;CompanyData."Ship-to Name")
                    {
                    }
                    ...
                    dataitem(DataItem4003;Table337)
                    {
                        ...
                        column(Reservation_Entry__Reservation_Entry___Exterior_Colour_Name_;"Reservation Entry"."Exterior Colour Name")
                        {
                        }
                        column(Reservation_Entry__Reservation_Entry___Location_Code_;"Reservation Entry"."Location Code")
                        {
                        }
                        ...
                        begin
                            ...
                            ItemLedgEntry.SETRANGE("Serial No.","Reservation Entry"."Serial No.");
                            IF ItemLedgEntry.FINDFIRST THEN BEGIN
                              ColourName := ItemLedgEntry."Exterior Colour Name";
                              "Reservation Entry"."Exterior Colour Code" := ItemLedgEntry."Exterior Colour Name";
                            END;
                        end;
                    }
                    ...
                    begin
                        ...
                        IF SKU.GET("Sales Line"."Location Code","Sales Line"."No.","Sales Line"."Variant Code") THEN
                          BEGIN
                    ...
                    begin
                        ...
                        CurrReport.CREATETOTALS("Sales Line"."Qty. to Ship");
                    end;
                }
