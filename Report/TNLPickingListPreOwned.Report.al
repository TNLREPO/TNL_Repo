...
{
    DefaultLayout = RDLC;
    RDLCLayout = './TNLPickingListPreOwned.rdlc';
        ...
        dataitem(DataItem6640; Table36)
        {
            ...
            dataitem(Counter;Table2000000026)
            {
                ...
                dataitem(DataItem2844;Table37)
                {
                    ...
                    column(Colour_SalesLine;"Sales Line".Colour)
                    {
                    }
                    ...
                    column(YearofProduction_SalesLine;"Sales Line"."Year of Production")
                    {
                    }
                    ...
                    column(EstimatedMileage_SalesLine;"Sales Line"."Estimated Mileage")
                    {
                    }
