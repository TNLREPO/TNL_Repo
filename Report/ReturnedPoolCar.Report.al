report 50440 "Returned Pool Car"
{
    DefaultLayout = RDLC;
    RDLCLayout = './ReturnedPoolCar.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000036; Table70003)
        {
            ...
            column(ActualReturnDate_PoolCarAllocation; "Pool Car Allocation"."Actual Return Date")
            {
            }
            column(ReturnTime_PoolCarAllocation; "Pool Car Allocation"."Return Time")
            {
            }
            column(ActualHours_PoolCarAllocation; "Pool Car Allocation"."Actual Hours")
            {
            }
            column(ReturnLocation1; "Pool Car Allocation"."Return Location1")
            {
            }
            column(ReturnLocation2; "Pool Car Allocation"."Return Location2")
            {
            }
            column(MileageonReturn2; "Pool Car Allocation"."Mileage on Return2")
            {
            }
            column(TakeoffLocation; "Pool Car Allocation"."Take-off Location")
            {
            }
            column(MileageinTransit; "Pool Car Allocation"."Mileage in Transit")
            {
            }
            column(SecurityOfficer; "Pool Car Allocation"."Security Officer")
            {
            }
