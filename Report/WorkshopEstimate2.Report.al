report 50375 "Workshop Estimate 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './WorkshopEstimate2.rdlc';
        ...
        dataitem(DataItem7672; Table50119)
        {
            ...
            dataitem(DataItem6850; Table50122)
            {
                ...
                begin
                    ...
                    CustOrderLine.SETRANGE("Job Type", "Customer Order Line"."Job Type"::PM, "Customer Order Line"."Job Type"::GR);
