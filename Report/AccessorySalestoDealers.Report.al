report 50445 "Accessory Sales to Dealers"
{
    DefaultLayout = RDLC;
    RDLCLayout = './AccessorySalestoDealers.rdlc';
    Caption = 'Acessory Sales to Dealers';
    ...
    dataset
    {
        dataitem(DataItem6836; Customer)
        {
            ...
            column(TotalCaption; Item."Alternative Item No.")
            {
            }
    ...
    var
        ...
        Customer_Item_SalesCaptionLbl: Label 'Accessory Sales to Dealers';
        ...
        TotalCaptionLbl: Label 'Grand Total';
