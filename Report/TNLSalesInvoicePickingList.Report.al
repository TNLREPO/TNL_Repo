report 50286 "TNL Sales Invoice/Picking List"
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/TNLSalesInvoicePickingList.rdl';
    ...
    dataset
    {
        dataitem(SalesInvHeader; "Sales Invoice Header")
        {
            ...
            column(CompanyData_Bank_Name; CompanyData."Bank Name")
            {
            }
            column(CompanyData_Bank_Account_No; CompanyData."Bank Account No.")
            {
            }
            column(CompanyData_Address; CompanyData.Address)
            {
            }
            column(CompanyDataAltCompName; CompanyData."Alt Comp. Name")
            {
            }
            ...
            column(Amount_SalesInvoiceHeader; SalesInvHeader.Amount)
            {
            }
            ...
            column(SalesInvoiceLine_GetCurrencyCode; SalesInvLineData.GetCurrencyCode)
            {
            }
            ...
            column(PostingTime_SalesInvoiceHeader; SalesInvHeader.Posting_Time)
            {
            }
            column(LogisticsApprovedBy_SalesInvoiceHeader; SalesInvHeader."Logistics Approved By")
            {
            }
            column(FinanceApprovedBy_SalesInvoiceHeader; SalesInvHeader."Finance Approved By")
            {
            }
            ...
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(CompanyInfoTINNo; CompanyInfo."TIN No.")
                    {
                    }
                    column(CompanyInfoVATNo; CompanyInfo."VAT No.")
                    {
                    }
                    ...
                    dataitem(SalesInvLineData; "Sales Invoice Line")
                    {
                        ...
                        column(Colour_SalesInvoiceLine; SalesInvLineData.Colour)
                        {
                        }
                        column(ChassisNumber_SalesInvoiceLine; SalesInvLineData."Chassis Number")
                        {
                        }
                        column(UOM_SalesInvLine; "Unit of Measure")
                        {
                        }
                        column(VAT_SalesInvoiceLine; SalesInvLineData."VAT %")
                        {
                        }
                        ...
                        column(LocationCode_SalesInvoiceLine; SalesInvLineData."Location Code")
                        {
                        }
                        ...
                        column(ItemCategoryCode_SalesInvoiceLine; SalesInvLineData."Item Category Code")
                        {
                        }
                        ...
                        dataitem(DimensionLoop2; Integer)
                        {
                            ...
                            begin
                                ...
                                DimSetEntry2.SETRANGE("Dimension Set ID", SalesInvLineData."Dimension Set ID");
                            end;
                        }
                        ...
                        trigger OnAfterGetRecord()
                        begin
                            IF SalesInvLineData.Quantity = 0 THEN
                                CurrReport.SKIP;
                    ...
                    dataitem(VATCounter; Integer)
                    {
                        ...
                        {
                            AutoFormatExpression = SalesInvLineData.GetCurrencyCode;
                            AutoFormatType = 1;
                        }
                ...
                begin
                    ...
                    //SalesInvCountPrinted.RUN(SalesInvHeader);
                end;
            ...
            begin
                ...
                END;
                //FormatAddr.SalesInvShipTo(ShipToAddr,SalesInvHeader);
...
#pragma warning restore AL0432
    ...
    begin
        NextEntryNo := 1;
        IF SalesInvLineData."Shipment No." <> '' THEN
            IF SalesShipmentHeader.GET(SalesInvLineData."Shipment No.") THEN
                EXIT(SalesShipmentHeader."Posting Date");

        IF SalesInvHeader."Order No." = '' THEN
            EXIT(SalesInvHeader."Posting Date");

        CASE SalesInvLineData.Type OF
            SalesInvLineData.Type::Item:
                GenerateBufferFromValueEntry(SalesInvLineData);
            SalesInvLineData.Type::"G/L Account", SalesInvLineData.Type::Resource,
          SalesInvLineData.Type::"Charge (Item)", SalesInvLineData.Type::"Fixed Asset":
                GenerateBufferFromShipment(SalesInvLineData);
            SalesInvLineData.Type::" ":
                EXIT(0D);
        END;

        SalesShipmentBuffer.RESET;
        SalesShipmentBuffer.SETRANGE("Document No.", SalesInvLineData."Document No.");
        SalesShipmentBuffer.SETRANGE("Line No.", SalesInvLineData."Line No.");
        IF SalesShipmentBuffer.FIND('-') THEN BEGIN
            ...
            IF SalesShipmentBuffer.Quantity <> SalesInvLineData.Quantity THEN BEGIN
                SalesShipmentBuffer.DELETEALL;
                EXIT(SalesInvHeader."Posting Date");
            END;
        END ELSE
    ...
    begin
        ...
        IF SalesInvLineData.Type <> SalesInvLineData.Type::Item THEN
            EXIT;
        ValueEntry.SETCURRENTKEY("Document No.");
        ValueEntry.SETRANGE("Document No.", SalesInvLineData."Document No.");
        ValueEntry.SETRANGE("Document Type", ValueEntry."Document Type"::"Sales Invoice");
        ValueEntry.SETRANGE("Document Line No.", SalesInvLineData."Line No.");
