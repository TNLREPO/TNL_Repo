report 50047 "TCSC Stock Issue Voucher"
{
    DefaultLayout = RDLC;
    RDLCLayout = './TCSCStockIssueVoucher.rdlc';
    ...
    dataset
    {
        dataitem(DataItem2957; Table5740)
        {
            ...
            column(ReceptionDate_TransferHeader; "Reception Date")
            {
            }
            ...
            column(ServiceAdvisorName_TransferHeader; "Transfer Header"."Service Advisor Name")
            {
            }
            dataitem(CopyLoop; Table2000000026)
            {
                ...
                dataitem(PageLoop; Table2000000026)
                {
                    ...
                    column(COF_No; "Transfer Header"."COF No")
                    {
                    }
