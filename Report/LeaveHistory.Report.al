report 50096 "Leave History"
{
    ...
    dataset
    {
        dataitem(DataItem8187; Table50075)
        {
            ...
            begin
                "Leave Plan Lines Rev 2".SETRANGE("Leave Plan Lines Rev 2"."Entry Type", "Leave Plan Lines Rev 2"."Entry Type"::ACTUAL);
                "Leave Plan Lines Rev 2".SETFILTER("Leave Plan Lines Rev 2"."Actual Start Date", '<=%1', actend);
                "Leave Plan Lines Rev 2".SETFILTER("Leave Plan Lines Rev 2"."Actual End Date", '>=%1&<=%2', actstart, actend);
            end;
        }
    }
