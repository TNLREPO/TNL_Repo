report 50022 Transfer2
{
    DefaultLayout = RDLC;
    RDLCLayout = 'Layout/Transfer2.rdl';
    Caption = 'Transfer Order';

    dataset
    {
        dataitem(TransferHeaderData; "Transfer Header")
        {
            ...
            column(AssignedUserID_TransferHeader; "Assigned User ID")
            {
            }
            dataitem(CopyLoop; Integer)
            {
                ...
                dataitem(PageLoop; Integer)
                {
                    ...
                    column(InTransitCode_TransHdr; TransferHeaderData."In-Transit Code")
                    {
                        IncludeCaption = true;
                    }
                    column(PostingDate_TransHdr; FORMAT(TransferHeaderData."Posting Date", 0, 4))
                    {
                    }
                    ...
                    dataitem(DataItem9370; "Transfer Line")
                    {
                        ...
                        DataItemLinkReference = TransferHeaderData;
            ...
            begin
                ...
                FormatAddr.TransferHeaderTransferFrom(TransferFromAddr, TransferHeaderData);
                FormatAddr.TransferHeaderTransferTo(TransferToAddr, TransferHeaderData);
