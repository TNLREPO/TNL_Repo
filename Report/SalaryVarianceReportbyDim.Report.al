...
{
    DefaultLayout = RDLC;
    RDLCLayout = './SalaryVarianceReportbyDim.rdlc';

    dataset
    {
        dataitem(Department; Table349)
        {
                   ...
                   BEGIN
                    FOR c:=1 TO TL DO
                     ...
                     END;
                      ...
                      IF NoOfPlus[Cols]>0 THEN
                      BEGIN
                        FOR c:=1 TO NoOfPlus[Cols] + 1 DO
                        BEGIN
    ...
    begin
          CumED.GET(EdTAB[i]);
          IF EdValueTypeTAB[i] = EdValueTypeTAB::Amount THEN
          BEGIN
           CASE EdTypeTAB[i] OF
            EdTypeTAB::" ":
