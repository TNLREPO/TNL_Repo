report 50381 "VAT/Remaining amt. analysis"
{
    DefaultLayout = RDLC;
    RDLCLayout = './VATRemainingamtanalysis.rdlc';
    ...
    dataset
    {
        dataitem(DataItem1000000000; Table21)
        {
            ...
            column(LoanID_CustLedgerEntry; "Cust. Ledger Entry"."Loan ID")
            {
            }
            column(LoanType_CustLedgerEntry; "Cust. Ledger Entry"."Loan Type")
            {
            }
            ...
            begin
                ...
                IF "Document Type" = "Document Type"::Invoice THEN BEGIN
                    SalesInvHead.SETFILTER(SalesInvHead."No.", "Cust. Ledger Entry"."Document No.");
                    SalesInvHead.SETFILTER(SalesInvHead."Bill-to Customer No.", "Cust. Ledger Entry"."Customer No.");
                    SalesInvHead.FINDFIRST;
                    VATAmt := ("Cust. Ledger Entry".Amount * (5 / 100));
                END;
            end;
