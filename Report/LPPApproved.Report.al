report 50075 "LPP Approved"
{
    ...
    dataset
    {
        dataitem(DataItem1; Table70018)
        {
            ...
            column(DepartmentCode1_LocalPartPurchaseRegister; "Local Part Purchase Register"."Department Code")
            {
            }
            ...
            column(ComplianceCheck1_LocalPartPurchaseRegister; "Local Part Purchase Register".ComplianceCheck)
            {
            }
            ...
            dataitem(DataItem75; Table70019)
            {
                ...
                column(QuantityAvailable2_LPPLine; "LPP Line"."Quantity Available")
                {
                }
