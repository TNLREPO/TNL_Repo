report 50313 "Job Instruction 2"
{
    DefaultLayout = RDLC;
    RDLCLayout = './JobInstruction2.rdlc';
    ...
    dataset
    {
        dataitem(DataItem7672; Table50119)
        {
            ...
            column(Customer_Order_Table___Customer_Order_Form_No__; "Customer Order Table."."Customer Order Form No.")
            {
            }
            ...
            dataitem(DataItem6850; Table50122)
            {
                ...
                column(JobCategory_CustomerOrderLine; "Customer Order Line"."Job Category")
                {
                }
