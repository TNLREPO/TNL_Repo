report 50002 "Cheque Receipt-Mult."
{
    DefaultLayout = RDLC;
    RDLCLayout = './ChequeReceiptMult.rdlc';
    ...
    dataset
    {
        dataitem(DataItem5195; Table50103)
        {
            ...
            dataitem(DataItem1385; Table50104)
            {
                ...
                column(Receivedby_PaymentReceiptBalLine;"Payment/Receipt Bal. Line."."Received by")
                {
                }
    ...
    var
        ...
        vendor: Record "23";
        bank: Record "270";
        CustomerAddr: array [8] of Text[35];
        "fixed": Record "5600";
