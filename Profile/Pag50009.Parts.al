    ...
    actions
    {
        ...
        area(sections)
        {
            ...
            group(Action62)
            {
                ...
                action(SearchTrack)
                {
                    ...
                    Caption = 'Search Tracker';
                    RunObject = Page "Search Tracker List";
                    ToolTip = 'Process items to be sold on sales order.';
                }
                ...
                action(BranchStockMgt)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Branch Stock Management';
                    RunObject = Page "Branch Stock Management List";
        ...
        area(processing)
        {
            ...
            group(Reports)
            {
                ...
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Stock Issue Report';
                    Image = "Report";
                    RunObject = Report "Stock Issue Voucher";
                    ToolTip = 'View or print stock issue voucher.';
                }
                action("TNL Sales Contribution")
                {
                    ...
                    ToolTip = 'View or print sales contribution.';
                }
                action(SalesContr)
                {
                    ApplicationArea = Basic, Suite;
                ...
                action(CustItemSales)
                {
                    ...
                    Caption = 'Customer/Item Sales';
                    Image = "Report";
                    RunObject = Report "Customer Item Sale-Part";
                    ToolTip = 'View or print customer and item sales report.';
                }
                action(TCSCSales)
                {
                    ApplicationArea = Basic, Suite;
                    Caption = 'Part Sales (TCSC)';
                    Image = "Report";
                    RunObject = Report "Part Sales To TCSC";
                    ToolTip = 'View or print stock issue voucher.';
                }
