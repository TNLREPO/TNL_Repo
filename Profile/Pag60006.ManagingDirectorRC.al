page 60006 "Managing Director Role Center"
{
...
#pragma warning restore AL0432
        ...
        area(embedding)
        {
            ...
            {
                ApplicationArea = All;
                Caption = 'Capex Approval - Bal/Full';
            ...
            {
                ApplicationArea = All;
                Caption = 'Opex Approval - Bal/Full';
            ...
            action(LeaveAppr)
            {
                ...
                RunObject = page "MD Approval List";
            }
            action(ProcAppr)
            {
                ApplicationArea = All;
