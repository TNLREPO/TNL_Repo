tableextension 50008 "Item Ext" extends Item
{
    fields
    {
        ...
        field(50001; "Stock Date"; Date)
        {
            ...
            CalcFormula = Min("Item Ledger Entry"."Posting Date" WHERE("Item No." = FIELD("No."),
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Count(Item WHERE("Inventory Posting Group" = FIELD("Inventory Posting Grp Filter"),
                                            Inventory = FIELD("Inv Quantity Filter")));
            Editable = false;
        ...
        {
            FieldClass = FlowField;
            CalcFormula = Sum("Sales Line"."Qty. to Ship" WHERE("Document Type" = CONST("Blanket Order"),
                                                                 Type = CONST(Item),
                                                                "No." = FIELD("No."),
        ...
        field(70132; "ISOLO-PRIC"; Decimal)
        {

            CalcFormula = Lookup("Price List Line"."Unit Price" WHERE("Product No." = FIELD("No."),
                                                                   "Assign-to No." = FILTER('ISOLO-PRIC')));
            FieldClass = FlowField;
        }
